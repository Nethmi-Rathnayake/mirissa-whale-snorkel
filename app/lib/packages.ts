...
export const packages: TourPackage[] = [
  {
    ...
    heroVideo: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870307/mirissa-whale-snorkel/whale-snorkeling-hero.mp4",
    videos: [
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870120/mirissa-whale-snorkel/whale-snorkeling-clip-1.mp4", label: "In the Water with Whales" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870127/mirissa-whale-snorkel/whale-snorkeling-clip-2.mp4", label: "Snorkeling Alongside Giants" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870159/mirissa-whale-snorkel/whale-snorkeling-clip-3.mp4", label: "A Close Encounter" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870195/mirissa-whale-snorkel/whale-snorkeling-clip-4.mp4", label: "Whale Snorkeling Highlights" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870226/mirissa-whale-snorkel/whale-snorkeling-clip-5.mp4", label: "Guided by Our Crew" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870249/mirissa-whale-snorkel/whale-snorkeling-clip-6.mp4", label: "Whale Snorkeling Adventure" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870258/mirissa-whale-snorkel/whale-snorkeling-clip-7.mp4", label: "Out on the Boat" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870295/mirissa-whale-snorkel/whale-snorkeling-clip-8.mp4", label: "Whale Sighting" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870299/mirissa-whale-snorkel/whale-snorkeling-clip-9.mp4", label: "In the Water" },
    ],
    price: {
      kind: "tiered",
      tiers: [
  ...
  },
  {
    ...
    videos: [
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869814/mirissa-whale-snorkel/fun-diving-clip-1.mp4", label: "Reef Dive Highlights" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869857/mirissa-whale-snorkel/fun-diving-clip-2.mp4", label: "Exploring the Reef" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869934/mirissa-whale-snorkel/fun-diving-clip-3.mp4", label: "Diving with the Crew" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869972/mirissa-whale-snorkel/fun-diving-clip-4.mp4", label: "Underwater Moments" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869975/mirissa-whale-snorkel/fun-diving-clip-5.mp4", label: "Reef Life Up Close" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869982/mirissa-whale-snorkel/fun-diving-clip-6.mp4", label: "A Day of Fun Diving" },
    ],
    price: {
      kind: "flat",
      price: 45,
  ...
  },
  {
    ...
    videos: [
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869731/mirissa-whale-snorkel/discover-scuba-diving-clip-1.mp4", label: "First Breath Underwater" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869747/mirissa-whale-snorkel/discover-scuba-diving-clip-2.mp4", label: "Guided Reef Introduction" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869759/mirissa-whale-snorkel/discover-scuba-diving-clip-3.mp4", label: "Discover Scuba Highlights" },
    ],
    price: {
      kind: "flat",
      price: 70,
  ...
  },
  {
    ...
    videos: [
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870082/mirissa-whale-snorkel/snorkeling-with-turtles-clip-1.mp4", label: "Snorkeling with Turtles Highlights" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870091/mirissa-whale-snorkel/snorkeling-with-turtles-clip-2.mp4", label: "Face to Face with a Turtle" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870104/mirissa-whale-snorkel/snorkeling-with-turtles-clip-3.mp4", label: "A Gentle Encounter" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870110/mirissa-whale-snorkel/snorkeling-with-turtles-clip-4.mp4", label: "Guided Turtle Snorkel" },
    ],
    price: {
      kind: "flat",
      price: 20,
  ...
  },
  {
    ...
    videos: [
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870023/mirissa-whale-snorkel/padi-bubblemaker-clip-1.mp4", label: "Kids' First Dive" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870029/mirissa-whale-snorkel/padi-bubblemaker-clip-2.mp4", label: "Shallow Reef Exploring" },
      { src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870046/mirissa-whale-snorkel/padi-bubblemaker-clip-3.mp4", label: "Bubblemaker Highlights" },
    ],
    price: {
      kind: "flat",
      price: 65,
