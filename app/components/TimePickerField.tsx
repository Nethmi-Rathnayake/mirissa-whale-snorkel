  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div ref={containerRef} className="relative">
        ...
        {mounted && (
          <div
            className={`absolute left-0 top-full z-30 mt-2 max-h-64 w-40 origin-top overflow-y-auto rounded-2xl border border-border bg-white p-2 shadow-xl transition-all duration-300 ease-out ${
              visible
