...
const GALLERY_VIDEOS = [
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869731/mirissa-whale-snorkel/discover-scuba-diving-clip-1.mp4",
    alt: "First Breath Underwater",
    span: "row-span-2",
    category: "discover-scuba-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869747/mirissa-whale-snorkel/discover-scuba-diving-clip-2.mp4",
    alt: "Guided Reef Introduction",
    span: "",
    category: "discover-scuba-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869759/mirissa-whale-snorkel/discover-scuba-diving-clip-3.mp4",
    alt: "Discover Scuba Highlights",
    span: "",
    category: "discover-scuba-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870023/mirissa-whale-snorkel/padi-bubblemaker-clip-1.mp4",
    alt: "Kids' First Dive",
    span: "row-span-2",
    category: "padi-bubblemaker-seal-team",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870029/mirissa-whale-snorkel/padi-bubblemaker-clip-2.mp4",
    alt: "Shallow Reef Exploring",
    span: "",
    category: "padi-bubblemaker-seal-team",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870046/mirissa-whale-snorkel/padi-bubblemaker-clip-3.mp4",
    alt: "Bubblemaker Highlights",
    span: "",
    category: "padi-bubblemaker-seal-team",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788870082/mirissa-whale-snorkel/snorkeling-with-turtles-clip-1.mp4",
    alt: "Snorkeling with Turtles Highlights",
    span: "col-span-2",
    category: "snorkeling-with-turtles",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869814/mirissa-whale-snorkel/fun-diving-clip-1.mp4",
    alt: "Reef Dive Highlights",
    span: "row-span-2",
    category: "fun-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869857/mirissa-whale-snorkel/fun-diving-clip-2.mp4",
    alt: "Exploring the Reef",
    span: "",
    category: "fun-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869934/mirissa-whale-snorkel/fun-diving-clip-3.mp4",
    alt: "Diving with the Crew",
    span: "",
    category: "fun-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869972/mirissa-whale-snorkel/fun-diving-clip-4.mp4",
    alt: "Underwater Moments",
    span: "col-span-2",
    category: "fun-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869975/mirissa-whale-snorkel/fun-diving-clip-5.mp4",
    alt: "Reef Life Up Close",
    span: "",
    category: "fun-diving",
  },
  {
    src: "https://res.cloudinary.com/ehjp8bsp/video/upload/v1788869982/mirissa-whale-snorkel/fun-diving-clip-6.mp4",
...
const GALLERY_IMAGES = [
  ...
  {
    src: "/images/night-diving-hero.jpg",
    alt: "Divers exploring a reef lit only by their torches at night",
    span: "row-span-2",
    category: "night-diving",
  },
  {
    src: "/images/night-diving-card.jpg",
    alt: "Divers with torches inspecting a coral reef at night",
    span: "",
    category: "night-diving",
  },
  {
  ...
  {
    src: "/images/bubblemaker-girls-pool-scuba.jpg",
    alt: "Two kids in scuba gear smiling in the pool during a Bubblemaker session",
    span: "col-span-2",
    category: "padi-bubblemaker-seal-team",
  },
  {
    src: "/images/bubblemaker-instructor-child-pool.jpg",
    alt: "An instructor holding a child's hand during a pool scuba introduction",
    span: "",
    category: "padi-bubblemaker-seal-team",
  },
  {
