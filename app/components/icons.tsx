...
export function VesselIcon({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="20"
    ...
    >
      ...
      <path d="M6 16V9h9l3 7" />
      <path d="M11 9V4h1a4 4 0 0 1 4 4v1" />
    </svg>
  );
}
...
export function ShieldIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 3 4 6v6c0 4.5 3.1 7.9 8 9 4.9-1.1 8-4.5 8-9V6l-8-3Z" />
...
export function LeafIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M20 4c0 9-5 14-14 14H4c0-9 5-14 14-14h2Z" />
      <path d="M5 19c4-4 7-7 13-13" />
    </svg>
  );
}
...
export function WhatsAppIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M17.5 14.4c-.3-.1-1.6-.8-1.9-.9-.3-.1-.4-.1-.6.1-.2.2-.7.9-.8 1-.2.2-.3.2-.5.1-.3-.1-1.2-.4-2.2-1.4-.8-.7-1.4-1.6-1.5-1.9-.2-.3 0-.5.1-.6.1-.1.3-.3.4-.5.1-.1.2-.3.2-.4.1-.2 0-.3 0-.5-.1-.1-.6-1.4-.8-1.9-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3-.2.2-.9.9-.9 2.2s1 2.6 1.1 2.7c.1.2 2 3 4.7 4.2.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.5-.1 1.6-.7 1.9-1.3.2-.6.2-1.1.2-1.2-.1-.2-.3-.2-.6-.4Z" />
      <path d="M20.5 3.5A11 11 0 0 0 3.2 17.2L2 22l4.9-1.3a11 11 0 0 0 5.2 1.3h.1a11 11 0 0 0 8.3-18.5Zm-8.3 17a9 9 0 0 1-4.6-1.3l-.3-.2-3.2.8.9-3.1-.2-.3a9 9 0 1 1 16.8-4.5 9 9 0 0 1-9.4 8.6Z" />
    </svg>
  );
}
...
export function LifeBuoyIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m7.2 7.2 2.5 2.5M14.3 14.3l2.5 2.5M16.8 7.2l-2.5 2.5M9.7 14.3l-2.5 2.5" />
    </svg>
  );
}
